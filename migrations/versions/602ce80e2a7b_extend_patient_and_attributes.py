...
def upgrade():
    ...
    op.add_column('patients', sa.Column('external_patient_id', sa.String(100), nullable=True))
    ...
    op.create_table(
        ...
        sa.Column('created_at', sa.TIMESTAMP(True), nullable=False, default=datetime.datetime.utcnow),
        sa.Column('updated_at', sa.TIMESTAMP(True), nullable=False, default=datetime.datetime.utcnow),
        sa.Column('last_modified', sa.TIMESTAMP(True), nullable=False, default=datetime.datetime.utcnow),
        sa.Column('server_created_at', sa.TIMESTAMP(True), nullable=False, default=datetime.datetime.utcnow),
