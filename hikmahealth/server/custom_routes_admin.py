                ...
                for field in patient_attribute_columns:
                    ...
                    for row in cur.fetchall():
                        try:
                            ...
                            logging.error(f"Error processing patient attribute field value: {e}")
                            continue
            ...
            for form_id, field_ids in event_fields.items():
                ...
                for field_id in field_ids:
                    ...
                    for row in results:
                        ...
                        relevant_fields = filter(lambda x: x["fieldId"] == field_id, form_data)
                        ...
                        for field in relevant_fields:
                            try:
                                ...
                                logging.error(f"Error processing event field value: {e}")
                                continue
