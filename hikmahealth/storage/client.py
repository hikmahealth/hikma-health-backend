...
def _get_configuration_from_envrionment():
    ...
    if store_type == "gcp":
        ...
        assert service_acc_details is not None, "missing GCP_SERVICE_ACCOUNT_B64 configuration"

        service_acc_details = json.loads(base64.b64decode(service_acc_details, validate=True))
        credentials = service_account.Credentials.from_service_account_info(service_acc_details)
