import pytest
from hikmahealth.utils.misc import to_snake_case, convert_dict_keys_to_snake_case, convert_operator, is_valid_uuid, safe_json_dumps
...
@pytest.mark.parametrize("operator,case_insensitive,expected", [
    ('contains', True, 'ILIKE'),
    ('contains', False, 'LIKE'),
...
@pytest.mark.parametrize("uuid_string,version,expected", [
